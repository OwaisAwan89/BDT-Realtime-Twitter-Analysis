...
if __name__ == "__main__":
    ...
    print(" TETTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT")
    ...
    toHive = tweets_sentiment_analysed. \
        map(lambda aTweet: json.dumps({"user": aTweet[0],
                                       "tweet": aTweet[1],
                                       "sentiment": (aTweet[2])}))

    #toHive.saveAsTextFiles("hdfs://localhost/user/cloudera/SparkStreaning/json-")
